/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 7935c2a5b75a521bcfd854137c9d7088)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	GOOGLE_LOGIN_RATE_LIMITER: RateLimit;
	OAUTH_AUTHORIZE_RATE_LIMITER: RateLimit;
	OAUTH_TOKEN_RATE_LIMITER: RateLimit;
	OAUTH_USERINFO_RATE_LIMITER: RateLimit;
	OAUTH_END_SESSION_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ISSUER" | "BETTER_AUTH_SECRETS" | "AUTH_ADMIN_USER_ID" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ALLOWED_GOOGLE_DOMAIN">> {}
}
