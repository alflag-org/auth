/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.operator.jsonc --env-interface=OperatorEnv worker-operator-configuration.d.ts` (hash: a380c560aa640b2bdd8329291a9f147c)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_OperatorEnv {
	DB: D1Database;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/operator");
	}
	interface Env extends __BaseEnv_OperatorEnv {}
}
interface OperatorEnv extends __BaseEnv_OperatorEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ISSUER" | "BETTER_AUTH_SECRETS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ALLOWED_GOOGLE_DOMAIN" | "OPERATOR_NONCE" | "OPERATOR_ACTION">> {}
}
